<template>
  <div class="topbar">
    <div class="tb-left">
      <a href="###" class="back fa fa-angle-left" title="返回"></a>
      <div class="project-info">
        <span>{{project.name}}</span>
        <i class="fa fa-edit"></i>
      </div>
      <div class="project-set">
        <el-dropdown trigger="click" placement="bottom-start" size="mini" @command="handleCommand">
    ...
    <div class="tb-right">
      <a href="###" class="download" @click="download">下载</a>
      <div class="user">
