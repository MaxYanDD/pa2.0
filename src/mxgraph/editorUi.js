 ...
 */
let EditorUi = function(editor, container, lightbox)
{
	...
	this.actions = new Actions(this); // 新增加actions
...
mxEventSource.prototype.test = 'aaa';
...
EditorUi.prototype.undo = function()
{
	try
	{
		...
		if (graph.isEditing())  
		{
			...
			console.log(value,graph.cellEditor.textarea.innerHTML);
			if (value == graph.cellEditor.textarea.innerHTML) // 如果文本框内没有文本
			{
