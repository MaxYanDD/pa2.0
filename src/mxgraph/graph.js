 ...
 *  Graph构造函数
 */
let Graph = function (id,xml,container, model, renderHint, stylesheet, _editor,bgColor,bgImgSrc) {
 ...
 *  画布外层wrapper
 */
Graph.prototype.container_wrap = function () {
    return document.querySelector('.page-list')
}

/**
 *  返回计算样式
 */
Graph.prototype.getCompStyle = function (ele, style) {
...
if (typeof mxVertexHandler != 'undefined') {
    (function () {
        ...
        HoverIcons.prototype.rotationHandle = new mxImage((mxClient.IS_SVG) ? 'data:image/svg+xml;base64,' :
            IMAGE_PATH + '/handle-rotate.png', 15, 15);
