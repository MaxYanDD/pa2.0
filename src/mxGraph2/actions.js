...
Actions.prototype.init = function()
{
	...
	this.addAction('autosize', function() // 自适应大小
	{
		var cells = graph.getSelectionCells();
		if (cells != null)
		{
	...
	this.addAction('formattedText', function() // 已格式化文本
	{
	...
	this.addAction('wordWrap', function() // 自动换行
	{
    	var state = graph.getView().getState(graph.getSelectionCell());
    	var value = 'wrap';
	...
	this.addAction('rotation', function() // 顶部菜单栏 arrange -> direction -> rotation
	{
	...
	this.addAction('zoomIn', function(evt) { graph.zoomIn(); console.log('放大')}, null, null, Editor.ctrlKey + ' + (Numpad) / Alt+Mousewheel');
	this.addAction('zoomOut', function(evt) { graph.zoomOut(); console.log('缩小')}, null, null, Editor.ctrlKey + ' - (Numpad) / Alt+Mousewheel');
	...
	toggleFontStyle('bold', mxConstants.FONT_BOLD, function() { document.execCommand('bold', false, null); console.log('黑体')}, Editor.ctrlKey + '+B');
	toggleFontStyle('italic', mxConstants.FONT_ITALIC, function() { document.execCommand('italic', false, null); console.log('斜体')}, Editor.ctrlKey + '+I');
	toggleFontStyle('underline', mxConstants.FONT_UNDERLINE, function() { document.execCommand('underline', false, null); console.log('下划线')}, Editor.ctrlKey + '+U');
	...
	this.addAction('borderColor...', function() {console.log('borderColor'); ui.menus.pickColor(mxConstants.STYLE_LABEL_BORDERCOLOR); });
